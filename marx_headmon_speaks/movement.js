...
const imgURLs = [
  ...
  './gifs/perfect-performance-mh.gif',
  './gifs/god-become-ai-mh.gif',
  './gifs/potted-plant-mh.gif',
  './gifs/static-image-mh.gif',
  './gifs/desire-itself-mh.gif',
  './gifs/digitally-normalize-mh.gif',
  './gifs/illusions-mh.gif',
  './gifs/immortality-mh.gif'
];
...
function cycleBib() {
  hideImgs();
  showImgs();
  setTimeout(cycleBib, 1200000); // how often bib is shown
}
// cycleBib();